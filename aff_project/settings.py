"""
Django settings for aff_project project.
...
TEMPLATE_DIR = os.path.join(BASE_DIR,'aff_site/templates/aff_site')
...
WSGI_APPLICATION = 'aff_project.wsgi.application'
...
#changes in order to use postgres on heroku
